...
var mapDispathToProps = function mapDispathToProps(dispatch, props) {
    return (0, _redux.bindActionCreators)({
        onSubmit: function onSubmit(payload) {
            payload = (0, _dissoc2.default)('passwordConfirm', payload);
            return (0, _actions.passwordConfirm)(payload, { url: props.url });
        },
        clearMeta: (0, _compose2.default)(_actionHelpers.asReset, _actions.passwordConfirm)
    }, dispatch);
};

var PasswordConfirm = exports.PasswordConfirm = (_dec = (0, _connect2.default)(null, mapDispathToProps), _dec2 = (0, _reduxForm.reduxForm)({ form: _actionTypes.PREFIX + 'passwordConfirm' }), _dec(_class = _dec2(_class = (_temp2 = _class2 = function (_Component) {
