...
var mapDispathToProps = function mapDispathToProps(dispatch, props) {
    return (0, _redux.bindActionCreators)({
        onSubmit: (0, _compose2.default)((0, _assoc2.default)('url', props.url), _actions.login),
        clearMeta: (0, _compose2.default)(_actions.asReset, _actions.login)
    }, dispatch);
};

var Login = exports.Login = (_dec = (0, _connect2.default)(mapStateToProps, mapDispathToProps), _dec2 = (0, _reduxForm.reduxForm)({ form: _actions.PREFIX + 'login' }), _dec(_class = _dec2(_class = (_temp2 = _class2 = function (_Component) {
