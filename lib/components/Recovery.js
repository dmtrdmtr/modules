        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'label',
                    null,
                    _react2.default.createElement(_reduxForm.Field, { name: 'url-with-token', component: 'input', style: { display: 'none' } })
                ),
...
var inject = function inject(_ref2, _ref3) {
    var modules = _ref2.modules;
    var getRecoveryUrl = _ref3.getRecoveryUrl;
    return {
        initialValues: {
            email: '',
...
var mapDispathToProps = function mapDispathToProps(dispatch, props) {
    return (0, _redux.bindActionCreators)({
        onSubmit: (0, _compose2.default)(assoc('url', props.url), _actions.sendRecoveryEmail),
