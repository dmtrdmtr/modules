...
function requestGenerator(actionFn, action) {
    var composedActionFn, response;
    return _regenerator2.default.wrap(function requestGenerator$(_context) {
        while (1) {
            switch (_context.prev = _context.next) {
                case 0:
                    composedActionFn = (0, _compose2.default)((0, _merge2.default)((0, _omit2.default)(['type', 'payload'], action)), actionFn);
                    _context.prev = 1;
                    _context.next = 4;
                    return (0, _effects.put)((0, _actionHelpers.asRequest)(composedActionFn(null)));
                ...
                case 6:
                    ...
                    _context.next = 9;
                    return (0, _effects.put)((0, _actionHelpers.asSuccess)(composedActionFn(response)));
                ...
                case 12:
                    ...
                    _context.next = 16;
                    return (0, _effects.put)((0, _actionHelpers.asError)(composedActionFn(_context.t0)));
