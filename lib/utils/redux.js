...
var createAction = exports.createAction = (0, _curryN2.default)(2, function (type) {
            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        _context.prev = 0;
                        _context.next = 3;
                        return (0, _effects.put)(asRequest(actionFn(null)));
                    ...
                    case 5:
                        ...
                        _context.next = 8;
                        return (0, _effects.put)(asSuccess(actionFn(response)));
                    ...
                    case 11:
                        ...
                        _context.next = 15;
                        return (0, _effects.put)(asError(actionFn(_context.t0)));
